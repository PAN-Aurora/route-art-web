package com.dyx.controller.tools;

import com.dyx.controller.base.BaseController;
import com.dyx.entity.PageData;
import com.dyx.util.GENDbFH;
...
public class ReverseCreateCodeController extends BaseController {
    ...
    public Object listAllTable() {
        ...
        pd = this.getPageData();
        try {
            Object[] arrOb = GENDbFH.getTables(pd);
    ...
    public Object getFieldlist() throws Exception {
        ...
        List<Map<String, String>> columnList = GENDbFH.getFieldParameterLsit(GENDbFH.getFHCon(pd), pd.getString("table"), pd.getString("dbtype")); //读取字段信息
