...
(function ($) {
    $.fn.tips = function (options) {
        ...
        if (!$('#jquery_tips_style').length) {
            ...
            style += '.jq_tips_top{border-right:10px solid transparent;left:20px;bottom:0px;}';
            style += '.jq_tips_left{border-top:10px solid transparent;right:0px;top:18px;}';
            style += '.jq_tips_bottom{border-right:10px solid transparent;left:20px;top:0px;}';
            ...
            switch (options.side) {
                ...
                case 3:
                    tips.css({
                        ...
                        left: element_left - 10 + options.y + element_width / 2
                    });
                    break;
                case 4:
                    tips.css({
