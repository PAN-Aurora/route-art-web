...
var setting = {
    ...
    async: {
        ...
        enable: true,
        //获取加载数据url
        // url: httpurl + 'dept/listLazyTree?TREEURL=kccx_list.html',
        url: httpurl + 'dept/deptSelect?TREEURL=kccx_list.html',
        //异步方式
        type: "post",
        //异步加载参数
        autoParam: ["DEPT_ID"],
...
function onAsyncSuccess(event, treeId, treeNode, msg) {
    ...
    if(nodes.length>0){
        ...
        $("#treeFrame").attr("src","kccx_list.html?id="+nodes[0].DEPT_ID);
    }
