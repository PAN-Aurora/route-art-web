...
function onClick(event, treeId, treeNode, msg){
    ...
    $("#treeFrame").attr("src",jhUrl+"&JDZBZBML_ID="+treeNode.JDZBZBML_ID+"&DEPT_ID="+DWDEPT_ID);
}
...
function onDwClick(event, treeId, treeNode, msg){
    ...
    var ZBJDZBZBML_ID;
    if(nodes.length>0){
        ZBJDZBZBML_ID = nodes[0].JDZBZBML_ID;
    }
    $("#treeFrame").attr("src",jhUrl+"&JDZBZBML_ID="+ZBJDZBZBML_ID+"&DEPT_ID="+treeNode.DEPT_ID);
}
