...
var setting = {
    ...
    async: {
        ...
        enable: true,
        //获取加载数据url
        url: httpurl + 'dictionaries/listLazyTree?DICTIONARIES_ID=1' ,
        //异步方式
        type: "post",
        //异步加载参数
        autoParam: ["DICTIONARIES_ID"],
        //跨域
        xhrFields: {
...
function save() {
    ...
    if (id == "") {
        ...
        console.info("jsonObject" + jsonObject.qynm);
        sessionStorage.setItem("ouqy", JSON.stringify(jsonObject));
    }
    top.Dialog.close();
}
