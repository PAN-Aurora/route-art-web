package com.dyx.service.${packageName}.impl;
...
import com.dyx.entity.${packageName}.${objectName};
import com.dyx.mapper.dsno1.${packageName}.${objectName}Mapper;
import com.dyx.service.${packageName}.${objectName}Service;
