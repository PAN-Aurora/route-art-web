    ...
    this.find(".step-header li").each(function (i, li) {
      if(i == 0){
        $(li).addClass("step-current")
            .append('<a href="javascript:void('+(i+1)+');" id="jump-steps'+i+'" class="jump-steps" data-step="'+(i+1)+'">'+(i+1)+'</a>');
      } else if (i<opts.initStep){
        $(li).addClass("step-active")
            .append('<a href="javascript:void('+(i+1)+');" id="jump-steps'+i+'" class="jump-steps" data-step="'+(i+1)+'"></a>');
      }else{
        $(li).append('<a href="javascript:void('+(i+1)+');" id="jump-steps'+i+'" class="jump-steps" data-step="'+(i+1)+'">'+(i+1)+'</a>');
      }
    });
