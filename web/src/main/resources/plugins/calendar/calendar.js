...
;(function ($, window, document, undefined) {
  ...
  Calendar.prototype = {
    showHoverInfo: function (obj) { // hover 时显示当天信息
      ...
      var offset_t = ($(obj).offset().top)/2 - 132 + (this.$calendar_today.height() - $(obj).height()) / 2;
      var offset_l = $(obj).offset().left;
    ...
    showCalendar: function () { // 输入数据并显示
      ...
      this.$calendarTitle_text.text(year + '年' + dateStr.substr(4, 2)+ '日');
