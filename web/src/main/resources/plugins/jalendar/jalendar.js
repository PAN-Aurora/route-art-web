...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            dayNames['CH'] = new Array('一', '二', '三', '四', '五', '六', '七');
            ...
            $this.append(
                ...
                div('div', 'jalendar-wood').append(
                    ...
                    div('div', 'jalendar-pages').append(
                        ...
                        div('div', 'total-bar').css("display","none").html( lTotalEvents[settings.lang] + '<b style="color: '+settings.color+'"></b>'),
                        div('div', 'days')
                    ),
                    div('div', 'add-event').append(
                        div('div', 'add-new').append(
                            '<input type="text" placeholder="' + lAddEvent[settings.lang] + '" value="" />',
                            div('div', 'submit'),
                            div('div', 'clear'),
