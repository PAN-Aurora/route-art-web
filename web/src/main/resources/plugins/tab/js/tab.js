...
function TabView(f) {
    ...
    var c = '<table class="tab_item"  id="{0}" border="0" cellpadding="0" cellspacing="0"><tr><td class="tab_item1"></td>\n'+
        '<td class="tab_item2 tab_title">{1}</td>\n'+
        '<td class="tab_item2"><div class="tab_close"></div></td><td class="tab_item3"></td></tr></table>';
    ...
    this.add = function (n) {
        ...
        if ($("#" + m.id).length > 0) {
            ...
            if (m.title.length < 4) {
                m.title = "<img src='/plugins/tab/skins/sky/tab/tab.png'></img>&nbsp;&nbsp;" + m.title + "&nbsp;"
            }
    ...
    this.update = function (k) {
        var l = k.id;
        k.title = "<div style='height:16px;'><img style='margin-top:-4px;' src='/plugins/tab/skins/sky/tab/tab.png'></img><span style='position:fixed;'>&nbsp;&nbsp;" + k.title + "&nbsp;</span></div>"
