...
import com.dyx.service.system.ButtonrightsService;
import com.dyx.service.system.FHlogService;
import com.dyx.service.system.FhButtonService;
...
public class MainController extends BaseController {
    ...
    public Object loginPage() throws Exception {
        ...
        if (user != null) {
            ...
            //根据appid过滤菜单
            //final String appid = (pd != null && pd.get("APPID") != null) ? pd.getString("APPID") : "-1";
            //menuList = menuList.parallelStream().filter(s -> s.getAPPID() != null && s.getAPPID().equals(appid)).collect(Collectors.toList());
