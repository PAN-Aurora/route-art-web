...
public class Page implements Serializable {
    ...
    //最终页面显示的底部翻页导航，详细见：getPageStrSimplify();
    private String pageStrSimplify;
    //最终页面显示的底部翻页导航，详细见：getPageStrSimplify2();
    ...
    public String getPageStr() {
        ...
        if (totalResult > 0) {
            ...
            if (currentPage == 1) {
                ...
                sb.append("	<li><input type=\"text\" value=\"1\" onkeyup=\"keyupfy()\"  oninput=\"value=value.replace(/[^0-9]/g,'')\" maxlength=\"5\" id=\"toGoPage\" style=\"width:36px;padding-top:5px;border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom: 1px solid #dbdbdb\" /></li>\n");
                ...
                sb.append("	<li style=\"padding-top:10px;\"><a>&nbsp;共" + totalResult + "条&nbsp;</a></li>\n");
                sb.append("	<li><input type=\"text\" onkeyup=\"keyupfy()\" oninput=\"value=value.replace(/[^0-9]/g,'')\" maxlength=\"10\" value=" + currentPage + " id=\"toGoPage\" style=\"width:36px;padding-top:5px;border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom: 1px solid #dbdbdb\" /></li>\n");
                sb.append("	<li style=\"cursor:pointer;padding-top:10px;\"><a onclick=\"vm.toTZ();\" >&nbsp;跳转&nbsp;</a></li>\n");
            ...
            sb.append("	<li style=\"padding-top:10px;\"><select title='显示条数' style=\"cursor:pointer;width:60px !important;float:left;margin-top:0px;border:none;background-color: rgba(255,255,255,0.6);\" onchange=\"vm.changeCount(this.value)\">\n");
            sb.append("	<option value='" + showCount + "'>" + showCount + "</option>\n");
            if (4 == showCount) {
                sb.append("	<option value='4'>4</option>\n");
            } else if (20 == showCount) {
