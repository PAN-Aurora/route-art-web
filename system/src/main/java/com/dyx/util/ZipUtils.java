...
public class ZipUtils {
    ...
    public static String unZipFiles(File zipFile, String descDir) throws IOException {
        ...
        //获取zip文件名并截取掉后缀
        String strName = zip.getName().substring(zip.getName().lastIndexOf("\\") + 1, zip.getName().lastIndexOf("."));
        //目标文件目录
        String unZipFilePath = descDir + strName;
        ...
        for (Enumeration<? extends ZipEntry> entries = zip.entries(); entries.hasMoreElements(); ) {
            ...
            String outPath = (descDir + strName + "/" + zipEntryName).replaceAll("\\*", "/");
